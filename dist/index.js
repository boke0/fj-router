var FjRouter = (function () {
  ...
  */
  ...
  let Link = _decorate([customElement("fj-link")], function (_initialize, _HTMLElement) {
  ...
  let Router = _decorate([customElement("fj-router")], function (_initialize2, _LitElement) {
    class Router extends _LitElement {
      constructor() {
        super();
